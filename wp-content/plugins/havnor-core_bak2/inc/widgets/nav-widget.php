...
class havnor_navigation_widget extends WP_Widget {
  ...
  public function __construct() {
    parent::__construct(
      'hanor-navigation-widget',
      VTHEME_NAME_P . __( ': Navigation', 'havnor' ),
      array(
        'classname'   => 'hanor-navigation-widget',
        'description' => VTHEME_NAME_P . __( ' widget that displays navigations list.', 'havnor' )
      )
    );
  }
  ...
  public function form( $instance ) {
    ...
    $nav_list_field = array(
      ...
      'type' => 'select',
      'options' => 'menus',
      'title' => __( 'Select Menu List :', 'havnor' ),
    );
    ...
    $nav_child_field = array(
      ...
      'title' => __( 'Display Menu Children :', 'havnor' ),
      'help' => __( 'This only shows first level of child menus.', 'havnor' ),
    );
  ...
  public function widget( $args, $instance ) {
    ...
    $nav_menu_args = array(
      ...
      'menu'        => $nav_list,
      'depth'       => $nav_child,
      'items_wrap'  => '<ul id="%1$s" class="%2$s hanor-sidenav">%3$s</ul>',
    );
...
function havnor_navigation_widget_function() {
  register_widget( "havnor_navigation_widget" );
}
add_action( 'widgets_init', 'havnor_navigation_widget_function' );
