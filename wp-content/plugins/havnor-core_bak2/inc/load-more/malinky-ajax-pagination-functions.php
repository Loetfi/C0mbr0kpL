...
if ( ! function_exists( 'malinky_ajax_pagination_ajax_loader' ) ) {
    ...
    {
        $ajax_loader_img = '<div class="hanor-mpreloader"><div class="mloader-wrap"><div class="mloader"><div class="mloader-inner"><div></div><div></div></div><img class="loader-icon" src="' . HAVNOR_PLUGIN_ASTS . '/images/icon4.png" alt="" /></div></div></div>';
